import { Car } from "@utils/@types/sqlite/car"
  ...
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      ...
      tx.executeSql(
        ...
        (_, error) => {reject(error);return false} // erro interno em tx.executeSql
      );
    });
  });
};
 ...
 */
const update = (id: string, obj: Car) => {
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      //comando SQL modificável
      tx.executeSql(
 ...
 */
const findByBrand = (brand: string) => {
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      //comando SQL modificável
      tx.executeSql(
